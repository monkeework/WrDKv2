...
#Keys moved to credentials

# For each customer/domain, get a key from http://recaptcha.net/api/getkey

#EDIT THE FOLLOWING:
#$toAddress = "XXX@gmail.com, XX@gmail.com , X@gmail.com";  //place your/your client's email address here ADDRESSES!
