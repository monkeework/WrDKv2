<?php
function maxDoc_users_userBegin(){
/**
...
function selectFirst($uID){//Select Customer
	global $config;
	...
	{//show results
		...
		echo '<tr>
				<th colspan="2" class="text-center">Set Start Page</th>
		...
		{//dbOut() function is a 'wrapper' designed to strip slashes, etc. of data leaving db
			...
			*/
			...
			if($select = 'threads'){echo 'checked'}
			...
			if($select = 'characters'){echo 'checked'}

			echo '> &nbsp; </td>
				<td> &nbsp; Character Index</td>
			</tr>
			<tr>
				<td> &nbsp; <input type="radio" name="UserStartPage" value="users/dashboard"';
			if($select = 'users/dashboard'){echo 'checked'}

			echo '>  &nbsp; </td>
				<td> &nbsp; Username Dashboard</td>
			</tr>
			<!-- We;ll add soem dev stuff later today -->
			<tr>
				<td> &nbsp; <input type="radio" name="UserStartPage" value="users/reviewCharacters"';
			if($select = 'users/reviewCharacters'){echo 'checked'}
