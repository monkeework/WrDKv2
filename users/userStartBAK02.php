...
$rteID  = 0; #userStart Rich Content Default ID
...
<?php
	if ($uPriv >= 5){ //show option to invoke editor
		 echo '<br /><a href="'. THIS_PAGE .'?act=edit&rteID=' . $rte00 . '" class="btn btn-primary btn-sm pull-right" role="button">Edit Text</a>';
	}
?>
