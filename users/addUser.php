...
include './../_inc/arrays-inc.php'; #provides configuration, et al.
...
{# if Email is set, check for valid data
	...
	<script type="text/javascript">
			...
			{//check form data for valid info
				if(empty(thisForm.UserName,"Please Enter User\'s Name")){return false;}
	...
	<div align="center"><a href="' . $config->userDashboard . '">Exit To Admin Page</a></div>
	';
